"""Plotter do touch sensor 5x5 (Windows). Retransmite por UDP para o PC do
ROS: 8082 (frame) = linhas brutas p/ a GUI (touch_pack) reconstruir tudo;
8081 (escalar) = I_final por frame, p/ touch_receiver_node. Leitura serial +
relay rodam em thread separada do desenho."""
import argparse
import re
import sys
import threading

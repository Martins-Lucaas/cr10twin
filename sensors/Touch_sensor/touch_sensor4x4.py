# Visualizador STM32 + Izhikevich (touch sensor 4x4). Retransmite por UDP
# para o PC do ROS: 8082 (frame) = linhas brutas p/ a GUI (touch_pack)
# reconstruir tudo; 8081 (escalar) = I_final '<If' por TOTAL, p/ touch_receiver_node.
# Relay roda na thread serial (best-effort), sem travar a plotagem.

...
"""
    ...
    # Minimal URDF for robot_state_publisher: gazebo_ros2_control fetches
    # robot_description from the RSP parameter service, which only declares
    # that exact name — any other parameter crashes the plugin (SIGSEGV).
    minimal = combined

...
def _inject_skin_layer(urdf_body: str) -> str:
    ...
    # 2) Palma (lisa) — usa colisão de malha; adiciona box-skin aproximado
    # ao redor da palma.
    palm_skin = (
...
def _build_robot_urdf():
    ...
    for lname in hand_link_names:
        ...
        # mu1/mu2 (atrito long./transversal): 2.5 nos pontos de captura
        # (falange/palma) para o objeto não escorregar sob impulso vertical.
...
def generate_launch_description():
    ...
    # GUI = manual_control (substitui o gui_control antigo).
    gui = Node(
        package='grasp_ml_pack',

...
class CellControlApp:
    ...
    def _build_ui(self):
        ...
        # transporta, solta na caixa, volta a HOME.
    ...
    def _poll_status(self):
        ...
        # Rótulo dinâmico do botão AGARRAR: mostra a preensão que será
        # aplicada ao objeto atualmente exposto, refletindo a associação
        # didática objeto↔grip (palm/claw/fingertip).

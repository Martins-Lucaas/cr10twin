...
class ManualControlNode(Node):
    ...
    def __init__(self, root: tk.Tk):
        ...
        # NOTA: o kinematic attach foi removido. O grasp é feito 100% por
        # contato físico (atrito ODE + esforço dos dedos COVVI).
        ...
        # toggle do header quando quiser proteção).
    ...
    def _max_sensor_value(self) -> int:
        ...
        # distância de cada ponta ao centro do AABB do objeto.
        ...
        if obj_bbox is not None and _COLLISION_OK:
            ...
            # Cada ponta: penalty pela "profundidade negativa" dentro do
            # AABB (clearance < 0 = dentro).
            max_force = 0
    ...
    # avanço da palma/fingertips para baixo do topo do objeto.
    ...
    def _do_pick_cycle(self, obj_class: str, step_by_step: bool = False,
        ...
        # Poses recentradas na posição REAL do objeto O objeto é o alvo —
        # não a coordenada canônica.
        ...
        # F3 — SEM pré-shape. A mão permanece TOTALMENTE ABERTA durante toda
        # a descida; o fechamento acontece SOMENTE em F5, após o braço estar
        # de fato sobre o objeto.
        def _f3():
        ...
        # F4 — descida final com mão AINDA aberta. A próxima fase só dispara
        # DEPOIS que o braço efetivamente chegou em `grasp_pose` (gating por
        # /joint_states, tolerância 1.5°).
        def _f4():
    ...
    def _do_delivery(self):
        ...
        # Para descida na caixa: replica DELIVERY_POSES_DEG mas com joint2
        # abaixado em ~5° (≈10 cm Cartesianos top-down) — pose de descent.
